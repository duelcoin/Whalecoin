...
int64 nChainStartTime = 1375995262;
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime)
{
    ...
    if(fTestNet || nTime > PROTOCOL_SWITCH_TIME)
    {
        ...
        // Whalecoin: reward for coin-year is cut in half every 64x multiply of PoS difficulty
...
static const int64 nTargetTimespan = 60 * 60;  // 120 blocks retarget
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Whalecoin
    bool fStrictPayToScriptHash = true; // Always active in Whalecoin
...
//vMerkleTree: ea6fed5e2
        // Genesis block
        const char* pszTimestamp = "ET  11/MAR/2015 Secret Service Agents Under Investigation for Allegedly Drinking and Driving";
        CTransaction txNew;
